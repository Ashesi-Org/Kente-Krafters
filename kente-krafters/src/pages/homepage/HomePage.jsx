	...
	return (
		<main className="container ">
			...
			<p className="px-10 mb-10">
				...
				Clergy Shirt and more, are made to traditional specifications
				providing you with the original fit you would expect. What makes
				us even different is the sustainability of our service.
			</p>
			...
			<div className="flex flex-row gap-20 mb-20">
				...
				<div>
					...
					<p className="mb-12">
						...
						Reliant Clergy Shirt and more, are made to traditional
						specifications providing you with the original fit you
						would expect. What makes us even different is the
