  ...
  return (
    <div className="max-w-screen-md mx-auto p-8 row">
      ...
      <main className="col-md-8">
        <header>
            <h1 className="text-2xl font-bold">Woven Kente Graduation Stole</h1>
            <p className="text-gray-600">Graduation Stoles, Gifts, and Decoration</p>
        </header>
          ...
          <div className="pt-4">
            ...
            <div className="row">
                <div className="quantity-button col-md-4">
                    <button id="decrement" className="btn">-</button>
                    <input type="text" id="quantity" className="quantity-input" value="1"></input>
                    <button id="increment" className="btn">+</button>
                </div>
