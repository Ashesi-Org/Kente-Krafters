...
CREATE TABLE Seller(
    ...
    ghana_region ENUM('Ashanti', 'Brong-Ahafo', 'Central', 'Eastern', 'Greater Accra', 'Northern', 'Upper East', 'Upper West', 'Volta', 'Western', 'Ahafo', 'Bono', 'Bono East', 'North East', 'Oti', 'Savannah'),
